...
[.small]#*Examples:*# +
&#xa0;&#xa0; `logger = Std$Out` [.small]#- outputs to stdout# +
&#xa0;&#xa0; `logger = Std$Err` [.small]#- outputs to stderr *[Default]*# +
&#xa0;&#xa0; `logger = Jdk` [.small]#- outputs using the JDK logger# +
&#xa0;&#xa0; `logger = Log4j` [.small]#- outputs using the Log4j 1 logger# +
&#xa0;&#xa0; `logger = Log4j2` [.small]#- outputs using the Log4j 2 logger# +
&#xa0;&#xa0; `logger = SLF4J` [.small]#- outputs using the SLF4J logger# +
&#xa0;&#xa0; `logger = File: /var/log/app/debugtrace.log` [.small]#- outputs directly to the file# +
&#xa0;&#xa0;&#xa0;&#xa0;&#xa0;&#xa0;&#xa0;&#xa0; [.small]#(since 3.4.0)# +
