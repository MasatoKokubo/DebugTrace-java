...
|Output format of the size of collections and maps +
[.small]#*設定例:*# +
...
|Limit of array, collection and map elements to output +
[.small]#*設定例:*# +
...
|`reflectionNestLimit` +
[.small .blue]#since 3.0.0#
|Limit of number of reflection nest +
[.small]#*Example:*# +
...
* Improved the line breaking algorithm.
