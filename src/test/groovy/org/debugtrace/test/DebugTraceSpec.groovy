...
class DebugTraceSpec extends Specification {
	...
	static commonSuffix = ' (' + DebugTraceSpec.class.simpleName + '.groovy:' // 2.4.4
	...
	def nonPrintPropertiesSpec() {
		...
		then:
			...
			DebugTrace.lastLog.indexOf('metaClass: ***') >= 0 // 2.4.4
	...
	def printSpec() {
		...
		then: DebugTrace.lastLog.indexOf('v = true') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
	...
	def simpleTypeNameSpec() {
		...
		then: DebugTrace.lastLog.indexOf('v = (java.util.Date)1970-01-01 00:00:01') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
		...
		then: DebugTrace.lastLog.indexOf('v = 00:00:01') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', new Timestamp(1234L))
		then: DebugTrace.lastLog.indexOf('v = 1970-01-01 00:00:01.234') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
	...
	def arrayTypeNameSpec() {
		...
		then: DebugTrace.lastLog.indexOf('v = (boolean[] length:2)[false, true]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', ['A', 'B'] as char[])
		then: DebugTrace.lastLog.indexOf('v = (char[] length:2)"AB"') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [1, 2] as byte[])
		then: DebugTrace.lastLog.indexOf('v = (byte[] length:2)[01 02]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [1, 2] as short[])
		then: DebugTrace.lastLog.indexOf('v = (short[] length:2)[1, 2]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [1, 2] as int[])
		then: DebugTrace.lastLog.indexOf('v = (int[] length:2)[1, 2]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [1, 2] as long[])
		then: DebugTrace.lastLog.indexOf('v = (long[] length:2)[1, 2]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [1.1, 2.2] as float[])
		then: DebugTrace.lastLog.indexOf('v = (float[] length:2)[1.1, 2.2]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [1.1, 2.2] as double[])
		then: DebugTrace.lastLog.indexOf('v = (double[] length:2)[1.1, 2.2]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
		...
		then: DebugTrace.lastLog.indexOf('v = (Character[] length:2)[\'A\', \'B\']') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [1, 2] as Byte[])
		then: DebugTrace.lastLog.indexOf('v = (Byte[] length:2)[1, 2]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
		...
		then: DebugTrace.lastLog.indexOf('v = (Integer[] length:2)[1, 2]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
		...
		then: DebugTrace.lastLog.indexOf('v = (BigDecimal[] length:2)[1.1, 2.2]') >= 0
		...
		then: DebugTrace.lastLog.indexOf('v = (....DebugTraceSpec.Fruits[] length:2)[(....DebugTraceSpec.Fruits)APPLE, (....DebugTraceSpec.Fruits)ORANGE]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
	...
	def listTypeNameSpec() {
		...
		when: DebugTrace.print('v', [new java.util.Date(1000), new java.util.Date(2000)])
		then: DebugTrace.lastLog.indexOf('v = (ArrayList size:2)[(java.util.Date)1970-01-01 00:00:01, (java.util.Date)1970-01-01 00:00:02]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [new Date(0), new Date(24*60*60*1000L)])
		then: DebugTrace.lastLog.indexOf('v = (ArrayList size:2)[1970-01-01, 1970-01-02]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [new Time(1000), new Time(2000)])
		then: DebugTrace.lastLog.indexOf('v = (ArrayList size:2)[00:00:01, 00:00:02]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [new Timestamp(1234), new Timestamp(2345)])
		then: DebugTrace.lastLog.indexOf('v = (ArrayList size:2)[1970-01-01 00:00:01.234, 1970-01-01 00:00:02.345]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
	...
	def mapTypeNameSpec() {
		...
		when: DebugTrace.print('v', [(new java.util.Date(1000)): new java.util.Date(2000)])
		then: DebugTrace.lastLog.indexOf('v = (LinkedHashMap size:1)[(java.util.Date)1970-01-01 00:00:01: (java.util.Date)1970-01-01 00:00:02]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [(new Date(0)): new Date(24*60*60*1000L)])
		then: DebugTrace.lastLog.indexOf('v = (LinkedHashMap size:1)[1970-01-01: 1970-01-02]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [(new Time(1000)): new Time(2000)])
		then: DebugTrace.lastLog.indexOf('v = (LinkedHashMap size:1)[00:00:01: 00:00:02]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4

		when: DebugTrace.print('v', [(new Timestamp(1234)): new Timestamp(2345)])
		then: DebugTrace.lastLog.indexOf('v = (LinkedHashMap size:1)[1970-01-01 00:00:01.234: 1970-01-01 00:00:02.345]') >= 0
			  DebugTrace.lastLog.indexOf(commonSuffix) >= 0 // 2.4.4
